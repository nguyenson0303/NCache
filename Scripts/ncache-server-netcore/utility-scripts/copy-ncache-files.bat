...
ECHO ===========================================
XCOPY "%SRCPATH%\NCCacheSeparateHost\bin\Release\netcoreapp2.1\publish\*.dll"							"%ncache%\lib" /Y /Q /S
XCOPY "%SRCPATH%\NCDaemon\bin\Release\netcoreapp2.1\publish\*.dll" 										"%ncache%\lib" /Y /Q /S
XCOPY "%SETUPUTILITIESPATH%\*.dll"																	"%ncache%\lib" /Y /Q /S
...
ECHO ===================================
XCOPY "%SRCPATH%\NCDaemon\bin\Release\netcoreapp2.1\publish\*.Daemon.dll" 								"%ncache%\bin\service" /Y /Q /S
XCOPY "%SRCPATH%\NCDaemon\bin\Release\netcoreapp2.1\publish\*.Daemon.runtimeconfig.json" 				"%ncache%\bin\service" /Y /Q /S
...
ECHO =====================================
XCOPY "%SRCPATH%\NCCacheSeparateHost\bin\Release\netcoreapp2.1\publish\*.CacheHost.dll" 				"%ncache%\bin\service" /Y /Q /S
XCOPY "%SRCPATH%\NCCacheSeparateHost\bin\Release\netcoreapp2.1\publish\*.CacheHost.runtimeconfig.json" 	"%ncache%\bin\service" /Y /Q /S
XCOPY "%SRCPATH%\NCCacheSeparateHost\bin\Release\netcoreapp2.1\publish\*.CacheHost.dll.config" 			"%ncache%\bin\service" /Y /Q /S
