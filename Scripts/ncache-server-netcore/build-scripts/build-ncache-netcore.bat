...
ECHO ==================================
dotnet	build 	-c Release    %SRCPATH%\NCWebCache\NCWebCache.NetCore.csproj
dotnet 	build 	-c Release    %SRCPATH%\NCSocketServer\NCSocketServer.NetCore.csproj	
...
dotnet 	publish -c Release    %SRCPATH%\NCCacheSeparateHost\NCCacheSeparateHost.NetCore.csproj
